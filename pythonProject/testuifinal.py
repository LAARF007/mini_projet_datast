...
def classify_image(file_path):
    ...
    class_label = 'M' if prediction[0] >= 0.5 else 'B'

    # Afficher la prédiction
    percentage = prediction[0] * 100

    # Afficher la prédiction
    print(f"Prédiction: {class_label} avec une probabilité de {percentage:.2f}%")
...
label = Label(root, text="Welcome to AI detection Cancer",
              font=("Arial", 20, "bold"),
              bg="Orange", foreground="white")
label.pack(side=TOP) #Right,left
# Bouton pour choisir un fichier
choose_button = tk.Button(root, text="Choisir une image", command=on_choose_button_click,bg="lightyellow", font=("Arial", 10),
                   borderwidth=1, activebackground="Green")
...
root.iconbitmap(r"D:\S6\IHM\projet\WhatsApp Image 2024-03-06 à 09.09.19_176ac5af.ico")
